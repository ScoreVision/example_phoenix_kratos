defmodule ExamplePhoenixKratosWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExamplePhoenixKratosWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExamplePhoenixKratosWeb.Gettext, "errors", msg, opts)
    end
  end
